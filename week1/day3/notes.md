...
let obj = {
 ...
 ```
For our object to be usefull we need:
...
obj["dog"] //=> "lola"
```
The second option is similar to how we get values from arrays but instead of getting the value indexed at anumber we are getting a value indexed at "dog".
...
If this is used in a method then it is happy and can refer to the object that that method exists in. 
```javascript
const obj = {
  thing: 1,
  myFunc: function(){
...
If this s called outside of any object or function it will refer to the global object, in node applications this will be the module object. 
```javascript
console.log(this);
